  ...
  const stats = [
    {
      ...
      suffix: "+",
      label: "Infra Audits",
      description: "Infrastructure assessments completed",
      icon: Building,
      color: "text-blue-500",
    ...
    },
    {
      ...
      number: 12,
      suffix: "+ LPA",
      label: "Roles Mentored",
      description: "High-paying positions secured",
      icon: Users,
    ...
    },
    {
      ...
      description: "In infrastructure optimization",
      icon: IndianRupee,
